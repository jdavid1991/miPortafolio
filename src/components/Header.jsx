...
export const Header = () => {
  return (
    <header>
      <Fade>
        <div className="2xl:h-222.25 sm:h-183 h-199 bg-[linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.9)),url('/assets/Develop.webp')] bg-contain sm:bg-cover sm:bg-center bg-fixed">
          {/* nav */}
          <nav>
