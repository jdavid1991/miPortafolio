        ...
        <div className="">
          ...
          <nav>
            <Slide direction="down">
              <div className="container mx-auto flex justify-between items-center pt-14 p-1">
                <div>
                  <svg
          ...
          {/* información */}
          <BackgroundPaths className="flex items-center justify-center w-full flex-col bg-black mt-40 sm:mt-0 mb-45 sm:mb-0">
            <div className="container mx-auto flex flex-col items-center justify-center">
              <div>
                <img
                  src={foto}
                  alt="foto"
                  className="2xl:w-40 w-35.5 rounded-full"
                  draggable="false"
              ...
              <div className="lg:w-[85%] text-white text-lg sm:text-2xl 2xl:text-3xl mt-5 flex flex-col items-center justify-center text-center">
                ...
                <button className="flex justify-center gap-4 md:gap-10 sm:mt-15 mt-10 ">
                  <a
                    ...
                    className="
                    w-40 py-3 mx-auto
                    flex items-center justify-center gap-2 bg-stone-900
